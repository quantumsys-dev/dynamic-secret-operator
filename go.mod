...
replace go.opentelemetry.io/otel => go.opentelemetry.io/otel v1.34.0

replace go.opentelemetry.io/otel/trace => go.opentelemetry.io/otel/trace v1.34.0

replace go.opentelemetry.io/otel/sdk => go.opentelemetry.io/otel/sdk v1.34.0

replace go.opentelemetry.io/otel/metric => go.opentelemetry.io/otel/metric v1.34.0

replace go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.59.0
...
replace golang.org/x/term => golang.org/x/term v0.27.0
...
replace golang.org/x/sync => golang.org/x/sync v0.10.0

replace golang.org/x/time => golang.org/x/time v0.8.0

replace golang.org/x/oauth2 => golang.org/x/oauth2 v0.24.0

replace golang.org/x/mod => golang.org/x/mod v0.22.0

replace oras.land/oras-go/v2 => oras.land/oras-go/v2 v2.5.0
...
replace github.com/moby/spdystream => github.com/moby/spdystream v0.5.0

replace google.golang.org/genproto/googleapis/rpc => google.golang.org/genproto/googleapis/rpc v0.0.0-20241104194629-dd2ea8efbc28

replace google.golang.org/genproto/googleapis/api => google.golang.org/genproto/googleapis/api v0.0.0-20241104194629-dd2ea8efbc28
