...
echo "=================================================================="
echo "🚀 Triggering Valid TLS Certificate Rotation for '${DOMAIN}'..."
...
echo ""
echo "📡 Event Flow: Key Vault -> Event Grid -> Service Bus -> DSO AMQP Peek-Lock -> Canary -> TLS Probe -> Promotion"
echo ""
